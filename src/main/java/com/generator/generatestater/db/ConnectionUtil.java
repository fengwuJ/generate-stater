package com.generator.generatestater.db;
...
public class ConnectionUtil {
    ...
    public boolean initConnection() {
        try {
            Class.forName(DataBaseFactory.getDriver(ConfigUtil.getConfiguration().getDb().getUrl(),ConfigUtil.getConfiguration().getDb().getDriverClass()));
